...
<div class="container-fluid">
         <div class="row">
          <p class="font-weight-light h2">Videos</p>
                <div class="card col-lg-3 ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/videos/embarazo_precoz')}}" method="GET">  <!-- Redireccionar a otra pagina -->
                                           {{ csrf_field() }}
                                           {{ method_field('GET') }}
                                        
                                           <button type="submit" class="btn btn-primary btn-block" id="modulo">Ver videos  </button>
                ...
                <div class="card col-lg-3 col-lg-offset-1 ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/videos/abuso')}}" method="GET">  <!-- Redireccionar a otra pagina -->
                                           {{ csrf_field() }}
                                           {{ method_field('GET') }}
                ...
                <div class="card col-lg-3 col-lg-offset-1">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/videos/enfermedades')}}" method="GET">  <!-- Redireccionar a otra pagina -->
                                           {{ csrf_field() }}
                                           {{ method_field('GET') }}
     ...
     <div class="row">
                <div class="card col-lg-3 ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/videos/nuestro_cuerpo')}}" method="GET">  <!-- Redireccionar a otra pagina -->
                                           {{ csrf_field() }}
                                           {{ method_field('GET') }}
                ...
                <div class="card col-lg-3 col-lg-offset-5 ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/videos/noviazgo')}}" method="GET">  <!-- Redireccionar a otra pagina -->
                                           {{ csrf_field() }}
                                           {{ method_field('GET') }}
